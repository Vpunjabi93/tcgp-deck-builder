...
// Normalise on write so app.js no longer needs the runtime patch
...
function buildCard(cardDetail, setId, setName) {
    ...
    // Backward-compat single `type` string
    let type;
    ...
    return {
        ...
        evolveFrom:  isPokemon ? (cardDetail.evolveFrom || null) : null,
        ...
        trainerType: isTrainer ? (cardDetail.trainerType || null) : null,
        effect:      (isTrainer || isEnergy) ? (cardDetail.effect || '') : null,
